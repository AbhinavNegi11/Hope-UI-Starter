...
export const ppmPlanTanents = async (
  token: any,
  tenantId?: any,
  selectedSite?: any,
  startDate?: any,
  ...
  try {
    ...
    const url = `${MASTER_URL}/dynamic/ppm-plan${
...
export const ppmPlanByEquipmentTanents = async (
  token: any,
  tenantId?: any,
  selectedSite?: any,
  startDate?: any,
  ...
  try {
    ...
    const url = `${MASTER_URL}/dynamic/ppm-plan/equipment${
      params.toString() ? `?${params.toString()}` : ""
    }`;
