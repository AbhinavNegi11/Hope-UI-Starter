...
export const getAllSites = async (token: string) => {
  try {
    const response = await fetch(
      `${MASTER_URL}/checklist-location-master/sites`,
      {
        method: "GET",
        headers: {
...
export const getBlocksBySiteId = async (token: string, siteId: string) => {
  try {
    const response = await fetch(
      `${MASTER_URL}/checklist-location-master/sites/${siteId}/blocks`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const getFloorsByBlockId = async (
  ...
  try {
    const response = await fetch(
      `${MASTER_URL}/checklist-location-master/sites/${siteId}/blocks/${blockId}/floors`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const getZonesByFloorId = async (
  ...
  try {
    const response = await fetch(
      `${MASTER_URL}/checklist-location-master/sites/${siteId}/blocks/${blockId}/floors/${floorId}/zones`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const getChecklistLocation = async (
  token: string,
  floorId: string,
  siteId: any,
  blockId: any
...
export const getChecklistLocationDept = async (token: string) => {
  try {
    const response = await fetch(
      `${MASTER_URL}/checklist-location-master/departments/by-login-user`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const getUserTenantData = async (token: string, id: any) => {
  try {
    const response = await fetch(
      `${MASTER_URL}/checklist-location-master/user/by-site-id/${id}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const createChecklistLocationStatus = async (
  token: string,
  payload: any
) => {
  try {
...
export const checklistLocationStatusChange = async (
  token: string,
  payload: any
) => {
  try {
    ...
    if (result) {
      if (result.status === "ACTIVE") {
        showToast("Checklist activated successfully", "success");
      } else {
        showToast("Checklist deactivated successfully", "success");
      }
    }
    return result;
  } catch (err: any) {
...
export const createChecklistLocationMatrix = async (
  token: string,
  payload: any
) => {
  try {
    const header = await getHeaders(token);
    const response = await fetch(
      `${MASTER_URL}/checklist-location/approval-matrix`,
      {
        method: "PUT",
        headers: header,
        body: JSON.stringify(payload),
...
export const getChecklistLocationMatrix = async (
  token: string,
  checklistId: any
) => {
  try {
    const header = await getHeaders(token);
    const response = await fetch(
      `${MASTER_URL}/checklist-location/${checklistId}/approval-matrix`,
      {
        method: "GET",
        headers: header,
      }
...
export const deleteChecklistLocationMatrix = async (
  token: string,
  checklistId: any,
  tenantId: any
) => {
  try {
    const header = await getHeaders(token);
    const response = await fetch(
      `${MASTER_URL}/checklist-location/approval-matrix/user-tenant?checklistLocationId=${checklistId}&userTenantId=${tenantId}`,
      {
        method: "DELETE",
        headers: header,
      }
...
export const createChecklistDescription = async (
  token: string,
  payload: any
) => {
  try {
    const header = await getHeaders(token);
    const response = await fetch(
      `${MASTER_URL}/checklist-location/checklist-department-description`,
      {
        method: "POST",
        headers: header,
        body: JSON.stringify(payload),
...
export const getChecklistLocationDesc = async (
  token: string,
  checklistLocationId: any,
  departmentId: any
) => {
  try {
    const response = await fetch(
      `${MASTER_URL}/checklist-location/description/${checklistLocationId}/${departmentId}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const deleteChecklistDescription = async (
  token: string,
  id: any,
  checklistLocationId: any,
  departmentId: any
  ...
  try {
    const response = await fetch(
      `${MASTER_URL}/checklist-location/description/${id}/${checklistLocationId}/${departmentId}`,
      {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const apporveLocationChecklist = async (token: string, id: any) => {
  try {
    const header = await getHeaders(token);
    const response = await fetch(
      `${MASTER_URL}/checklist/location_approval/approve?checklistId=${id}`,
      {
        method: "PUT",
        headers: header,
      }
...
export const rejectLocationChecklist = async (token: string, payload: any) => {
  try {
    const header = await getHeaders(token);
    const response = await fetch(
      `${MASTER_URL}/checklist/location_approval/reject`,
      {
        method: "PUT",
        headers: header,
        body: JSON.stringify(payload),
...
export const editLocationChecklist = async (token: string, payload: any) => {
  try {
    const header = await getHeaders(token);
    const response = await fetch(
      `${MASTER_URL}/checklist/location_approval/edit`,
      {
        method: "PUT",
        headers: header,
        body: JSON.stringify(payload),
...
//   try {
//     const response = await fetch(
//       `${MASTER_URL}/checklist-location/qrcode-location`,
//       {
//         method: "GET",
//         headers: {
//           Authorization: `Bearer ${token}`,
...
export const getLocationQrCodeData = async (
  token: string,
  selectedSite?: string,
  selectedBlock?: string,
  selectedFloor?: string,
  ...
  try {
    let url = `${MASTER_URL}/checklist-location/qrcode-location?site=${selectedSite}`;
    if (selectedBlock) {
      url += `&block=${selectedBlock}`;
    }
    if (selectedFloor) {
