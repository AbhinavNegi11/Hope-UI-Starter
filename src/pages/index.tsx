...
const Dashboard = memo((options) => {
  ...
  const getVariableColor = () => {
    if (typeof document !== "undefined") {
      let prefix =
        global.getComputedStyle(document.body).getPropertyValue("--prefix") ||
        "bs-";
      if (prefix) {
        prefix = prefix.trim();
      }
      ...
      const color3 = global
        .getComputedStyle(document.body)
        .getPropertyValue(`--${prefix}primary-tint-20`);
      const color4 = global
        .getComputedStyle(document.body)
      ...
      <div className="d-flex justify-content-between align-items-center flex-wrap mb-4 gap-3">
        ...
        <div className="d-flex justify-content-between align-items-center rounded flex-wrap gap-3">
          <div className="d-flex justify-content-between align-items-center">
            ...
            >
              {checked === false ? "Offline" : "Online"}
            </label>
          </div>
            <div className="form-group mb-0 custom-choicejs" style={{ minWidth: "200px" }}>
