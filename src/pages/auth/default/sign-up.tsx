         ...
         <section className="login-content">
            <Row className="m-0 align-items-center bg-white vh-100">
               <div className="col-md-6 d-md-block d-none bg-primary p-0 vh-100 overflow-hidden">
                  <Image src='/images/auth/05.png' width={960} height={1080}className="Image-fluid gradient-main animated-scaleX" alt="images" />
               </div>
               <Col md="6">
                                 ...
                                 <div className="d-flex justify-content-center">
                                    <ListGroup as="ul" className="list-group-horizontal list-group-flush">
                                       <ListGroup.Item as="li" className="list-group-item border-0 pb-0">
                                          <Link href="#"><Image src='/images/brands/fb.svg' width={41} height={40}alt="fb" /></Link>
                                       </ListGroup.Item>
                                       <ListGroup.Item as="li" className="list-group-item border-0 pb-0">
                                          <Link href="#"><Image src='/images/brands/gm.svg'width={41} height={40} alt="gm" /></Link>
                                       </ListGroup.Item>
                                       <ListGroup.Item as="li" className="list-group-item border-0 pb-0">
                                          <Link href="#"><Image src='/images/brands/im.svg'width={41} height={40} alt="im" /></Link>
                                       </ListGroup.Item>
                                       <ListGroup.Item as="li" className="list-group-item border-0 pb-0">
                                          <Link href="#"><Image src='/images/brands/li.svg'width={41} height={40} alt="li" /></Link>
                                       </ListGroup.Item>
                                    </ListGroup>
                                 </div>
                                 <p className="mt-3 text-center">
                                    Already have an Account <Link href="/auth/Default/login" className="text-underline">Sign In</Link>
                                 </p>
                              </Form>
                           </Card.Body>
                        </Card>
