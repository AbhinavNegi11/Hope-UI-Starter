      ...
      <Fragment>
         <section className="login-content">
            <Row className="m-0 align-items-center bg-white vh-100">
                              ...
                              <Form>
                                 <Row>
                                    ...
                                    <Col lg="12" className="d-flex justify-content-between">
                                       ...
                                       <Link href="/auth/Default/recover-password">Forgot Password?</Link>
                                    </Col>
                                 </Row>
                                 ...
                                 <div className="d-flex justify-content-center">
                                    <ListGroup as="ul" className="list-group-horizontal list-group-flush">
                                       <ListGroup.Item as="li" className="border-0 pb-0">
                                          <Link href="#"><Image src='/images/brands/fb.svg' width={40} height={40}  alt="fb" /></Link>
                                       </ListGroup.Item>
                                       <ListGroup.Item as="li" className="border-0 pb-0">
                                          <Link href="#"><Image src='/images/brands/gm.svg' width={40} height={40}  alt="gm" /></Link>
                                       </ListGroup.Item>
                                       <ListGroup.Item as="li" className="border-0 pb-0">
                                          <Link href="#"><Image src='/images/brands/im.svg'  width={40} height={40} alt="im" /></Link>
                                       </ListGroup.Item>
                                       <ListGroup.Item as="li" className="border-0 pb-0">
                                          <Link href="#"><Image src='/images/brands/li.svg'  width={40} height={40} alt="li" /></Link>
                                       </ListGroup.Item>
                                    </ListGroup>
                                 </div>
                                 <p className="mt-3 text-center">
                                    Don’t have an account? <Link href="/auth/Default/register" className="text-underline">Click here to sign up.</Link>
                                 </p>
                              </Form>
                           </Card.Body>
                        </Card>
               ...
               <Col md="6" className="col-md-6 d-md-block d-none bg-primary p-0 vh-100 overflow-hidden">
