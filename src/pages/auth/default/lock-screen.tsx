            ...
            <Row className="m-0 align-items-center bg-white vh-100">
               <Col md="6" className="p-0">
                  <Card className="card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                     <Card.Body>
                        <Link href="/dashboard" className="navbar-brand d-flex align-items-center mb-3">
                        ...
                        <Image src='/images/avatars/01.png' width={100} height={100} className="rounded avatar-80 mb-3" alt="" />
                        ...
                        <Form>
                           ...
                           <Button onClick={() => history.push('#')} type="button" variant="btn btn-primary">Login</Button>
                        </Form>
                     </Card.Body>
                  </Card>
               ...
               <Col md="6" className="col-md-6 d-md-block d-none bg-primary p-0 vh-100 overflow-hidden">
                  <Image src='/images/auth/04.png' width={1223} height={1080} className="img-fluid gradient-main animated-scaleX" alt="images" />
               </Col>
            </Row>
         </section>
      </Fragment>
