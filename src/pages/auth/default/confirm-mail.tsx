                  ...
                  <Card className="card-transparent auth-card shadow-none d-flex justify-content-center mb-3">
                     <Card.Body>
                        ...
                        <div className="d-inline-block w-100">
                           <Link href="/dashboard" className="btn btn-primary mt-3">Back to Home</Link>
                        </div>
                     </Card.Body>
                  </Card>          
               </Col>
               <Col md="6" className="col-md-6 d-md-block d-none bg-primary p-0 vh-100 overflow-hidden">
                  <Image src='/images/auth/03.png' width={960} height={1080} className="img-fluid gradient-main animated-scaleX" alt="images"/>
               </Col>
            </Row>
         </section>
      </Fragment>
