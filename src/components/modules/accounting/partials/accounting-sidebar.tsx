...
import Accountingvarticalnav from './accounting-vartical-nav'
...
const Accountingsidebar = memo((props: Props) => {
...
Accountingsidebar.displayName = "Accountingsidebar"
