...
import GeneralReportsverticalnav from './general-reports-vartical-nav'
...
const GeneralReportssidebar = memo((props: Props) => {
...
GeneralReportssidebar.displayName = "GeneralReportssidebar"
export default GeneralReportssidebar