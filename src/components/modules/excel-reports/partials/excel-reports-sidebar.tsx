...
//Excel-reports-vartical-nav
import ExcelReportsVerticalNav from './excel-reports-vertical-nav'
...
const ExcelReportssidebar = memo((props: Props) => {
...
ExcelReportssidebar.displayName = "ExcelReportssidebar"
export default ExcelReportssidebar
