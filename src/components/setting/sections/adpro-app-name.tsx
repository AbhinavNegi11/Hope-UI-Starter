...
const AdProAppName = memo((props:Props) => {
        ...
        <Fragment>
            ...
            <div className="d-grid gap-3 grid-cols-1 mb-4">
                <div className="form-group mb-0">
                    <input type="text" data-setting="input" className="form-control" defaultValue={props.appName} onChange={(e) => dispatch(SettingAction.app_name(e.target.value))}  name="app_name" />
                </div>
            </div>
        </Fragment>
    )
