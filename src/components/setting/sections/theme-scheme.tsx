...
const ThemeScheme = memo((props: Props) => {
    return (
        <Fragment>
            ...
            <div className="d-grid gap-3 grid-cols-2 mb-4">
                <RadioBtn btnName="theme_scheme_direction" imgComponent={true} label="LTR" className="text-center grid-wrap" labelclassName="p-0" id="theme-scheme-direction-ltr" defaultChecked={props.themeSchemeDirection} value="ltr" >
                    <Image src='/images/settings/dark/01.png' width={440} height={300} alt="ltr" className={`mode dark-img img-fluid`} data-setting="dir-mode" data-name="dir" data-value="ltr" loading="lazy" />
                    <Image src='/images/settings/light/01.png' width={440} height={300} alt="ltr" className={`mode light-img img-fluid`} data-setting="dir-mode" data-name="dir" data-value="ltr" loading="lazy" />
                ...
                <RadioBtn btnName="theme_scheme_direction" imgComponent={true} label="RTL" className="text-center" labelclassName="p-0" id="theme-scheme-direction-rtl" defaultChecked={props.themeSchemeDirection} value="rtl" >
                    <Image src='/images/settings/dark/02.png' width={440} height={300} alt="rtl" className={` mode dark-img img-fluid`} data-setting="dir-mode" data-name="dir" data-value="rtl" loading="lazy" />
                    <Image src='/images/settings/light/02.png' width={440} height={300} alt="rtl" className={` mode light-img img-fluid`} data-setting="dir-mode" data-name="dir" data-value="rtl" loading="lazy" />
                </RadioBtn>
            </div>
        </Fragment>
    )
