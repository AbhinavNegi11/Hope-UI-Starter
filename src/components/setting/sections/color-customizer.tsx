...
const ColorCustomizer = memo((props: Props) => {
  ...
  const updateColor = (colorClassName: string, colorObj: any) => {
  ...
  const colorChange = (colorClassName: string, colorObj: any, isDebounce = false) => {
    if (isDebounce) {
      ...
      <div className="d-flex align-items-center justify-content-between">
        ...
        <div className="d-flex align-items-center">
          ...
          <div data-setting="radio">
            ...
            />
            <label
              className="btn bg-transparent border-0 px-2"
              htmlFor="default"
          ...
          <div className="form-group d-flex justify-content-between align-items-center">
            ...
            <input
              ...
              onInput={(e) =>
                colorChange(
                  "custom",
                  { "--{{prefix}}primary": (e.target as HTMLInputElement).value },
                  true
                )
              }
              type="color"
          ...
          <div className="form-group d-flex d-flex justify-content-between align-items-center">
            ...
            <input
              ...
              onInput={(e) =>
                colorChange(
                  "custom",
                  { "--{{prefix}}secondary": (e.target as HTMLInputElement).value },
                  true
                )
              }
              type="color"
          ...
          <div className="form-group d-flex justify-content-between align-items-center">
            ...
            <input
              ...
              onInput={(e) =>
                colorChange(
                  "custom",
                  { "--{{prefix}}success": (e.target as HTMLInputElement).value },
                  true
                )
              }
              type="color"
          ...
          <div className="form-group d-flex justify-content-between align-items-center">
            ...
            <input
              ...
              onInput={(e) =>
                colorChange(
                  "custom",
                  { "--{{prefix}}danger": (e.target as HTMLInputElement).value },
                  true
                )
              }
              type="color"
          ...
          <div className="form-group d-flex justify-content-between align-items-center">
            ...
            <input
              ...
              onInput={(e) =>
                colorChange(
                  "custom",
                  { "--{{prefix}}warning": (e.target as HTMLInputElement).value },
                  true
                )
              }
              type="color"
          ...
          <div className="form-group d-flex justify-content-between align-items-center">
            ...
            <input
              ...
              onInput={(e) =>
                colorChange(
                  "custom",
                  { "--{{prefix}}info": (e.target as HTMLInputElement).value },
                  true
                )
              }
              type="color"
