                                        ...
                                        <div className="p-0 card-body">
                                            <Link href="#" className="iq-sub-card">
                                                <div className="d-flex align-items-center">
                                                    <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src={shapes1} alt="" loading="lazy"/>
                                            ...
                                            <Link href="#" className="iq-sub-card">
                                                <div className="d-flex align-items-center">
                                                    <div className="">
                                                        <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src={shapes2} alt="" loading="lazy"/>
                                                    </div>
                                                    <div className="ms-3 w-100">
                                            ...
                                            <Link href="#" className="iq-sub-card">
                                                <div className="d-flex align-items-center">
                                                    <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src={shapes3} alt="" loading="lazy"/>
                                                    <div className="ms-3 w-100">
                                            ...
                                            <Link href="#" className="iq-sub-card">
                                                <div className="d-flex align-items-center">
                                                    <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src={shapes4} alt="" loading="lazy"/>
                                    ...
                                    <div className="m-0 shadow-none card">
                                        ...
                                        <div className="p-0 card-body ">
                                            ...
                                            <Link href="#" className="iq-sub-card">
                                                <div className="d-flex align-items-center">
                                                    <div>
                                                        <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src={shapes5} alt="" loading="lazy"/>
                                                    </div>
                                                    <div className="ms-3">
