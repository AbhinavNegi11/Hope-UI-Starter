                                    ...
                                    <Card.Body className="p-0 max-17 scroll-thin">
                                        <div className="iq-sub-card">
                                            <div className="d-flex align-items-center">
                                                <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src="/images/shapes/01.png" width="100" height="100" alt="" loading="lazy" />
                                        ...
                                        <div className="iq-sub-card">
                                            <div className="d-flex align-items-center">
                                                <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src="/images/shapes/02.png" width="100" height="100" alt="" loading="lazy" />
                                                <div className="ms-3 flex-grow-1">
                                        ...
                                        <div  className="iq-sub-card">
                                            <div className="d-flex align-items-center">
                                                <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src="/images/shapes/03.png" width="100" height="100" alt="" loading="lazy" />
                                                <div className="ms-3 flex-grow-1">
                                        ...
                                        <div  className="iq-sub-card">
                                            <div className="d-flex align-items-center">
                                                <Image className="p-1 avatar-40 rounded-pill bg-soft-primary" src="/images/shapes/04.png" width="100" height="100" alt="" loading="lazy" />
                                                <div className="ms-3 flex-grow-1">
