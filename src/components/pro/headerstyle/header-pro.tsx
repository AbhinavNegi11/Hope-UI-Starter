...
const HeaderPro = memo((props) => {
  ...
  const navbarHideArray = Array.isArray(navbarHide)
    ? navbarHide
    : navbarHide.split(" ");
  ...
  return (
    <Navbar
      expand="xl"
      className={`nav iq-navbar header-hover-menu left-border ${headerNavbar} ${navbarHideArray.join(
        " "
      )}`}
    >
                ...
                <Nav.Item as="li" className="active">
                  ...
                  <Collapse in={open}>
                    ...
                    >
                      ...
                      <Nav.Item as="li">
                                                <Nav.Link className="menu-arrow" onClick={() => setOpen2(!open2)} aria-expanded={open2} role="button" aria-controls="authSkins">
                                                    Auth skins
                                                ...
                                                <Collapse in={open2}>
                                                    <ul className="iq-header-sub-menu left list-unstyled" id="authSkins">
                                                        <Nav.Item as="li">
                                                            <Nav.Link className="menu-arrow" onClick={() => setOpen3(!open3)} aria-expanded={open3} role="button" aria-controls="defaultAuth">
                                                                Defalut
                                                                <i className="right-icon">
                                                                    <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"></path>
                                                            ...
                                                            <Collapse in={open3}>
                                                                <ul className="iq-header-sub-menu left list-unstyled" id="defaultAuth">
                                                                    <Nav.Item as="li"><Link className={`${location.pathname === '/auth/default/sign-in' ? 'active' : ''} nav-link`} href="/auth/default/sign-in">Sign In</Link></Nav.Item>
                                                                    <Nav.Item as="li"><Link className={`${location.pathname === '/auth/default/sign-up' ? 'active' : ''} nav-link`} href="/auth/default/sign-up">Sign Up</Link></Nav.Item>
                                            ...
                                            <Nav.Item as="li">
                                                <Nav.Link className="menu-arrow" onClick={() => setOpen6(!open6)} aria-expanded={open6} role="button" aria-controls="utilities">
                                                    Utilities
                                                    <i className="right-icon">
                                                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M8.5 5L15.5 12L8.5 19" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"></path>
                                                ...
                                                <Collapse in={open6}>
                                                    <ul className="iq-header-sub-menu left list-unstyled" id="utilities">
                                                        ...
                                                        <Nav.Item as="li"><Link className={`${location.pathname === '/utilities/error500' ? 'active' : ''} nav-link`} href="/utilities/error500">505</Link></Nav.Item>
                                                    </ul>
                                                </Collapse>
                                            </Nav.Item>
                    </ul>
