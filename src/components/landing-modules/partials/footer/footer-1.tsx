...
const FooterOne = memo((prop: Props) => {
            ...
            <footer className="bg-secondary inner-box ">
                <Container>
                    <Row>
                        ...
                        <Col lg={3} md={6}>
                            <h5 className="mb-4 mb-lg-5 mt-5 mt-lg-0 text-white">Get In touch</h5>
                            <p className="text-white mb-4">Need help? Let us hear about it!</p>
                            <p className="text-white">Email us at:</p>
                            <Link href="#" className="text-decoration-underline text-white">
                                support@hopeui.com
                            </Link>
                                ...
                                <li>
                                    <Link href="#">
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
                                            <path d="M27.5 15C27.5 8.1 21.9 2.5 15 2.5C8.1 2.5 2.5 8.1 2.5 15C2.5 21.05 6.8 26.0875 12.5 27.25V18.75H10V15H12.5V11.875C12.5 9.4625 14.4625 7.5 16.875 7.5H20V11.25H17.5C16.8125 11.25 16.25 11.8125 16.25 12.5V15H20V18.75H16.25V27.4375C22.5625 26.8125 27.5 21.4875 27.5 15Z" fill="white"></path>
                                        </svg>
                                    </Link>
                                </li>
                                <li className="ps-3">
                ...
                <Container>
                    <Row>
                        <Col lg={12} className="text-center">
                            <p className="p-3 mb-0 text-secondary">© {currentYear} Hope UI, All Rights Reserved.</p>
                        </Col>
                    </Row>
                </Container>
            </div>
