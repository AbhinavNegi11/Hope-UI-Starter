  ...
  return (
    ...
    <div className="bg-secondary inner-box ">
        <Container>
                <Row>
                    <Col md={4}>
                        <Link href="/landing-pages" className="navbar-brand  d-flex align-items-center">
                        ...
                        <p className="mb-5 mt-4">It is a long established fact that a reader will be distracted by the readable content of a page when
                    ...
                    <Col md={4} className="mt-md-0 mt-4">
                        ...
                        <div className="input-group mb-4">
                            <input type="text" className="form-control input-email ps-0" placeholder="firstname.lastname@mail.com" aria-label="Username"
                                aria-describedby="basic-addon1"/>
                              <span className="input-group-text input-email-btn" id="basic-addon1">
                    ...
                    <ul className="list-unstyled p-0 m-0 d-flex mt-4 social-icon">
                        <li>
                            <Link href="#"><svg width="30" height="30" viewBox="0 0 30 30" fill="none">
                                              <path
