                ...
                <div className="sidebar-profile-body">
                    <div className="mb-3 d-flex justify-content-center">
                        <div className="rounded-3 border border-primary p-2">
                            <Image src="/images/avatars/01.png" alt="1" width="100" height="100" className="img-fluid rounded" />
                        </div>
                    </div>
                    ...
                    <div className="sidebar-profile-action d-flex gap-2 ms-5">
                        <Link href="/" className="d-flex" passHref>
                            <Button className="btn-icon btn-sm rounded-pill btn-action">
                                <span className="btn-inner">
                                    <svg width="32" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M3 10.5L12 3L21 10.5V20A1 1 0 0 1 20 21H15V15H9V21H4A1 1 0 0 1 3 20V10.5Z"
                                            fill="currentColor"
                                        />
                                    </svg>
                                </span>
