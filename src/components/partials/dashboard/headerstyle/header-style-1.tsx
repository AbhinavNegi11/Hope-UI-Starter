...
//React-bootstrap
import { Navbar, Dropdown, Container, Form, Button } from 'react-bootstrap'
...
import MobildeOffcanvas from '@/components/partials/components/mobile-offcanvas'
            ...
            <Navbar expand="xl" className="nav  iq-navbar">
                <Container fluid className="navbar-inner">
                    ...
                    <Navbar.Brand as="div" className="col-lg-2 col-lg-3 ">
                        <Link href="/dashboard" className="d-flex">
                            <Logo color={true} />
                            <h4 className="logo-title d-none d-sm-block">Hope UI</h4>
                        </Link>
                    </Navbar.Brand>
                    <HorizontalNav />
                    <Navbar.Toggle aria-controls="navbarSupportedContent" type="button" data-bs-toggle="collapse" aria-expanded={show1} data-bs-target="#navbarSupportedContent">
                        <span className="navbar-toggler-icon" onClick={() => setShow1(!show1)}>
                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                                    ...
                                    <Card className="m-0 shadow-none ">
                                        ...
                                        <Card.Footer className="p-0 text-center">
                                            <div className="d-grid">
                                                <Link href="/pro/e-commerce/order-process" className="btn btn-primary">View All</Link>
                                            </div>
                                        </Card.Footer>
                                    </Card>
                                </Dropdown.Menu>
                            ...
                            <li className="nav-item iq-full-screen d-none d-xl-block" id="fullscreen-item">
                                <Button href="#" bsPrefix=" nav-link" id="btnFullscreen" data-bs-toggle="dropdown" >
                                    <div className="btn btn-primary btn-icon btn-sm rounded-pill" onClick={() => { setShow(!show), openfullscreen() }}>
