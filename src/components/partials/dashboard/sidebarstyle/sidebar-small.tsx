        ...
        <Fragment>
            <aside className="sidebar sidebar-default sidebar-small">
                <div className="sidebar-header d-flex align-items-center justify-content-start">
                    <Link href="../dashboard/index.html" className="navbar-brand">
                ...
                <div className="sidebar-body pt-0">
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            ...
                            <Nav.Item as="li">
                                <Nav.Link  href="/menu-styles/horizontal">
                                    <i className="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Nav.Item as="li">
                                <Nav.Link  href="/menu-styles/dual-horizontal">
                                    <i className="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7.37121 10.2017V17.0618" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                            <path d="M12.0382 6.91919V17.0619" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                            ...
                            <Nav.Item as="li">
                                <Nav.Link href="/menu-styles/boxed">
                                    <i className="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Nav.Item as="li">
                                <Nav.Link href="/menu-styles/boxedfancy">
                                    <i className="icon">
                                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M15.7161 16.2234H8.49609" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                            <path d="M15.7161 12.0369H8.49609" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
