    ...
    return (
        <Fragment>
            <Accordion as="ul" className="navbar-nav iq-main-menu">
                ...
                <SidebarMenu isTag="true" pathname='/alternate-dashboard' title='Alternate Dashboard'>
                    <i className="icon" data-bs-toggle="tooltip" title="Alternate Dashboard" data-bs-placement="right">
                ...
                <Accordion.Item as="li" eventKey="horizontal-menu" bsPrefix={`nav-item ${active === 'menustyle' ? 'active' : ''} `} onClick={() => setActive('menustyle')} >
                    <CustomToggle eventKey="horizontal-menu" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="horizontal-menu" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon='true' minititle='H' pathname='/menu-styles/horizontal' title='Horizontal' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='D' pathname='/menu-styles/dual-horizontal' title='Dual Horizontal' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='D' pathname='/menu-styles/dual-compact' title='Dual Compact' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='B' pathname='/menu-styles/boxed' title='Boxed Horizontal' ></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon='true' minititle='B' pathname='/menu-styles/boxedfancy' title='Boxed Fancy' ></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Nav.Item as="li">
                    <Link className={`${location.pathname === '/' ? 'active' : ''} nav-link `} aria-current="page" target="blank" href="/">
                        <OverlayTrigger placement="right" overlay={<Tooltip>Design System</Tooltip>}>
                            <i className="icon">
                                <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="item-name">Design System<span className="badge rounded-pill bg-success item-name">UI</span></span>
                    </Link>
                </Nav.Item>
                <Accordion.Item as="li" eventKey="sidebar-e-commerce" bsPrefix={`nav-item ${active === 'e-commerce' ? 'active' : ''} `} onClick={() => setActive('e-commerce')} >
                    <CustomToggle eventKey="sidebar-e-commerce" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>E-Commerce</Tooltip>}>
                            <i className="icon">
                                <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="item-name">E-Commerce</span>
                        <i className="right-icon">
                            <svg className="icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <Accordion.Collapse eventKey="sidebar-e-commerce" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="true" pathname='/e-commerce/admin-dashboard' title='Admin Dashboard' minititle='A'>
                                <i className="icon">
                            ...
                            <SidebarMenu isTag="true" pathname='/e-commerce/vendor-dashboard' title='Vendor Dashboard' minititle='VD'>
                                <i className="icon">
                            ...
                            <Accordion as="ul" className="navbar-nav  sub-nav iq-main-menu">
                                <Accordion.Item as="li" eventKey="shop-main" bsPrefix={`nav-item  ${location.pathname === '/e-commerce/shop/shop-main' || location.pathname === '/e-commerce/shop-left-filter' ? 'active' : '' || location.pathname === '/e-commerce/shop/shop-right-filter' ? 'active' : '' || location.pathname === '/e-commerce/hop/product-grid-view' ? 'active' : '' || location.pathname === '/e-commerce/Shop/product-list-view' ? 'active' : '' || location.pathname === '/e-commerce/shop/categories-list' ? 'active' : '' || activeMenu === 'shop-main' ? 'active' : ''} `} >
                                    <CustomToggle className="nav-link" eventKey="shop-main" active={activeMenu === 'shop-main' ? true : false} onClick={(activeKey: any) => setActiveMenu(activeKey)} >
                                        <i className="icon">
                                            <svg className="icon-20" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                                <path fillRule="evenodd" clipRule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                                        ...
                                        <OverlayTrigger placement="right" overlay={<Tooltip>Shop</Tooltip>}>
                                            <i className="sidenav-mini-icon"> SP </i>
                                        </OverlayTrigger>
                                    ...
                                    <Accordion.Collapse eventKey="shop-main" >
                                        <ul className="sub-nav ">
                                            <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop/shop-main' title='Shop Main' minititle='SM'></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop/shop-left-filter' title='Shop Left Filter' minititle='SL'></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop/shop-right-filter' title='Shop Right Filter' minititle='SR'></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop/product-grid-view' title='Product Grid View' minititle='PG'></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop/product-list-view' title='Product List View' minititle='PL'></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/shop/categories-list' title='Categories List' minititle='C'></SidebarMenu>
                                        </ul>
                                    </Accordion.Collapse>
                                </Accordion.Item>
                                <Accordion.Item as="li" eventKey="products" bsPrefix={`nav-item   ${location.pathname === '/e-commerce/product-detail/product-details' ? 'active' : '' || location.pathname === '/e-commerce/product-detail/product-details-3d' ? 'active' : '' || location.pathname === '/e-commerce/product-detail/product-details-360' ? 'active' : ''}`}  >
                                    <CustomToggle eventKey="products" onClick={(activeKey: any) => setActiveMenu(activeKey)} className="nav-link" >
                                        <i className="icon">
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <i className="right-icon">
                                            <svg className="icon-20 submit" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                            </svg>
                                        </i>
                                    </CustomToggle>
                                    <Accordion.Collapse eventKey="products">
                                        <ul className="sub-nav " >
                                            <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/product-detail/product-details' title='Product Details' minititle='P'></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon="true" pathname='/e-commerce/product-detail/product-details-3d' title='3D Product Detail' minititle='3D'></SidebarMenu>
                                        </ul>
                                    </Accordion.Collapse>
                                </Accordion.Item>
                            </Accordion>
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/e-commerce/order-process' ? 'active' : ''} nav-link`} href="/e-commerce/order-process">
                                    <i className="icon">
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>Order Process</Tooltip>}>
                                        <i className="sidenav-mini-icon"> OP </i>
                                    </OverlayTrigger>
                            ...
                            <SidebarMenu isTag="false" pathname='/e-commerce/invoice' title='Invoice' minititle='I'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SidebarMenu isTag="false" pathname='/e-commerce/wishlist' title='Wishlist' minititle='W'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SidebarMenu isTag="false" pathname='/e-commerce/user-profile' title='User Profile' minititle='UP'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SidebarMenu isTag="false" pathname='/e-commerce/user-list' title='User List' minititle='UL'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-social" bsPrefix={`nav-item ${active === 'social' ? 'active' : ''} `} onClick={() => setActive('social')} >
                    <CustomToggle eventKey="sidebar-social" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>Social</Tooltip>}>
                            <i className="icon">
                                <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="item-name">Social</span>
                        <i className="right-icon">
                    ...
                    <Accordion.Collapse eventKey="sidebar-social" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" pathname='/social/dashboard' title='Social Dashboard' minititle='SD'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                            ...
                            <Nav.Item as="li" className={`${location.pathname === '/social/newsfeed' ? 'active' : ''}`}>
                                <Link className={`${location.pathname === '/social/newsfeed' ? 'active' : ''} nav-link`} href='/social/newsfeed'>
                                    <i className="icon">
                                    ...
                                    <div>
                                        <span className="badge bg-info rounded-pill d-inline-block">45</span>
                                    </div>
                                </Link>
                            </Nav.Item>
                            <Accordion as="ul" className="navbar-nav iq-main-menu sub-nav ">
                                <Accordion.Item as="li" eventKey="friend-list" bsPrefix={`nav-item ${location.pathname === '/social/friend-list' ? 'active' : '' || location.pathname === '/social/friend-requests' ? 'active' : '' || location.pathname === '/social/friend-profile' ? 'active' : ''}`}>
                                    <CustomToggle className="nav-link" eventKey="friend-list" active={activeMenu === 'friend-list' ? true : false} onClick={(activeKey: any) => setActiveMenu(activeKey)} >
                                        <i className="icon">
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <i className="right-icon">
                                            <svg className="submit icon-20" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                            </svg>
                                        </i>
                                    </CustomToggle>
                                    <Accordion.Collapse eventKey="friend-list" >
                                        <ul className="sub-nav">
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='FL' pathname='/social/friend-list' title='Friend List' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='FR' pathname='/social/friend-requests' title='Friend Request' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='FP' pathname='/social/friend-profile' title='Friend Profile' ></SidebarMenu>
                                        </ul>
                                    </Accordion.Collapse>
                                </Accordion.Item>
                                <Accordion.Item eventKey="Profile" as="li" bsPrefix={`nav-item ${location.pathname === '/social/profile-badges' ? 'active' : '' || location.pathname === '/social/profile-images' ? 'active' : '' || location.pathname === '/social/profile-video' ? 'active' : '' || location.pathname === '/social/birthday' ? 'active' : '' || location.pathname === '/social/notification' ? 'active' : '' || location.pathname === '/social/account-setting' ? 'active' : ''}`}>
                                    <CustomToggle eventKey="Profile" onClick={(activeKey: any) => setActiveMenu(activeKey)} className="nav-link" >
                                        <i className="icon">
                                            <svg className="icon-20" width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.997 15.1746C7.684 15.1746 4 15.8546 4 18.5746C4 21.2956 7.661 21.9996 11.997 21.9996C16.31 21.9996 19.994 21.3206 19.994 18.5996C19.994 15.8786 16.334 15.1746 11.997 15.1746Z" fill="currentColor"></path>
                                                <path opacity="0.4" d="M11.9971 12.5838C14.9351 12.5838 17.2891 10.2288 17.2891 7.29176C17.2891 4.35476 14.9351 1.99976 11.9971 1.99976C9.06008 1.99976 6.70508 4.35476 6.70508 7.29176C6.70508 10.2288 9.06008 12.5838 11.9971 12.5838Z" fill="currentColor"></path>
                                            </svg>
                                        </i>
                                    ...
                                    <Accordion.Collapse eventKey="Profile">
                                        <ul className="sub-nav">
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='PB' pathname='/social/profile-badges' title='Profile Badges' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='PI' pathname='/social/profile-images' title='Profile Images' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='PV' pathname='/social/profile-video' title='Profile video' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='B' pathname='/social/birthday' title='Birthday' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='N' pathname='/social/notification' title='Notification' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='A' pathname='/social/account-setting' title='Account setting' ></SidebarMenu>
                                        </ul>
                                    </Accordion.Collapse>
                                </Accordion.Item>
                                <Accordion.Item as="li" eventKey="Event List" bsPrefix={`nav-item ${location.pathname === '/social/event-list' || location.pathname === '/social/event-detail' ? 'active' : ''} `}>
                                    <CustomToggle className="nav-link" eventKey="Event List" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                                        <i className="icon">
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.4" d="M16.34 1.99976H7.67C4.28 1.99976 2 4.37976 2 7.91976V16.0898C2 19.6198 4.28 21.9998 7.67 21.9998H16.34C19.73 21.9998 22 19.6198 22 16.0898V7.91976C22 4.37976 19.73 1.99976 16.34 1.99976Z" fill="currentColor"></path>
                                                <path fillRule="evenodd" clipRule="evenodd" d="M11.1246 8.18921C11.1246 8.67121 11.5156 9.06421 11.9946 9.06421C12.4876 9.06421 12.8796 8.67121 12.8796 8.18921C12.8796 7.70721 12.4876 7.31421 12.0046 7.31421C11.5196 7.31421 11.1246 7.70721 11.1246 8.18921ZM12.8696 11.362C12.8696 10.88 12.4766 10.487 11.9946 10.487C11.5126 10.487 11.1196 10.88 11.1196 11.362V15.782C11.1196 16.264 11.5126 16.657 11.9946 16.657C12.4766 16.657 12.8696 16.264 12.8696 15.782V11.362Z" fill="currentColor"></path>
                                    ...
                                    <Accordion.Collapse eventKey="Event List">
                                        <ul className="sub-nav">
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='PE' pathname='/social/event-list' title='Profile Event' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='ED' pathname='/social/event-detail' title='Event Detail' ></SidebarMenu>
                                        </ul>
                                    </Accordion.Collapse>
                                </Accordion.Item>
                                <Accordion.Item as="li" eventKey="Group" bsPrefix={`nav-item ${location.pathname === '/social/group' ? 'active :' : '' || location.pathname === '/social/group-detail' ? 'active :' : ''}`}>
                                    <CustomToggle className="nav-link" eventKey="Group" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                                        <i className="icon">
                                            <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M11.9488 14.54C8.49884 14.54 5.58789 15.1038 5.58789 17.2795C5.58789 19.4562 8.51765 20.0001 11.9488 20.0001C15.3988 20.0001 18.3098 19.4364 18.3098 17.2606C18.3098 15.084 15.38 14.54 11.9488 14.54Z" fill="currentColor"></path>
                                                <path opacity="0.4" d="M11.949 12.467C14.2851 12.467 16.1583 10.5831 16.1583 8.23351C16.1583 5.88306 14.2851 4 11.949 4C9.61293 4 7.73975 5.88306 7.73975 8.23351C7.73975 10.5831 9.61293 12.467 11.949 12.467Z" fill="currentColor"></path>
                                    ...
                                    <Accordion.Collapse eventKey="Group">
                                        <ul className="sub-nav">
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='GL' pathname='/social/group' title='Group List' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='GD' pathname='/social/group-detail' title='Group Detail' ></SidebarMenu>
                                        </ul>
                                    </Accordion.Collapse>
                                </Accordion.Item>
                            </Accordion>
                            <SidebarMenu isTag="false" minititle='SP' pathname='/social/social-profile' title='Social Profile' >
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-blog" bsPrefix={`nav-item ${active === 'blog' ? 'active' : ''} `} onClick={() => setActive('blog')} >
                    <CustomToggle eventKey="sidebar-blog" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-blog" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" minititle='D' pathname='/blog/dashboard' title='Blog Dashboard'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                            ...
                            <Accordion as="li">
                                <Accordion.Item eventKey="Blogs" bsPrefix={`nav-item ${location.pathname === '/social/friend-list' ? 'active' : '' || location.pathname === '/social/friend-requests' ? 'active' : '' || location.pathname === '/social/friend-profile' ? 'active' : ''}`}>
                                    <CustomToggle className="nav-link" eventKey="Blogs" active={activeMenu === 'Blogs' ? true : false} onClick={(activeKey: any) => setActiveMenu(activeKey)} >
                                        <i className="icon">
                                    ...
                                    <Accordion.Collapse eventKey="Blogs" >
                                        <ul className="sub-nav">
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='BM' pathname='/blog/blog-main' title='Blog Main' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='BD' pathname='/blog/blog-details' title='Blog Details' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='BG' pathname='/blog/blog-grid' title='Blog Grid' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='BL' pathname='/blog/blog-list' title='Blog List' ></SidebarMenu>
                                            <SidebarMenu isTag="false" staticIcon='true' minititle='BT' pathname='/blog/blog-trending' title='Blog Trending' ></SidebarMenu>
                                        </ul>
                                    </Accordion.Collapse>
                                </Accordion.Item>
                            </Accordion>
                            <SidebarMenu isTag="false" minititle='CL' pathname='/blog/blog-comments' title='Comments List'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SidebarMenu isTag="false" minititle='BC' pathname='/blog/blog-category' title='Blog Category'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-appointment" bsPrefix={`nav-item ${active === 'appointment' ? 'active' : ''} `} onClick={() => setActive('appointment')} >
                    <CustomToggle eventKey="sidebar-appointment" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>Appointment</Tooltip>}>
                            <i className="icon">
                                <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span className="item-name">Appointment</span>
                        <i className="right-icon">
                            <svg className="submit icon-18" xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                            </svg>
                        </i>
                    </CustomToggle>
                    <Accordion.Collapse eventKey="sidebar-appointment" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" minititle='A' pathname='/appointment/dashboard' title='Appointment'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                            ...
                            <SidebarMenu isTag="false" minititle='BA' pathname='/appointment/book-appointment' title='Book Appointment'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M3 16.87V9.25699H21V16.931C21 20.07 19.0241 22 15.8628 22H8.12733C4.99561 22 3 20.03 3 16.87ZM7.95938 14.41C7.50494 14.431 7.12953 14.07 7.10977 13.611C7.10977 13.151 7.46542 12.771 7.91987 12.75C8.36443 12.75 8.72997 13.101 8.73985 13.55C8.7596 14.011 8.40395 14.391 7.95938 14.41ZM12.0198 14.41C11.5653 14.431 11.1899 14.07 11.1701 13.611C11.1701 13.151 11.5258 12.771 11.9802 12.75C12.4248 12.75 12.7903 13.101 12.8002 13.55C12.82 14.011 12.4643 14.391 12.0198 14.41ZM16.0505 18.09C15.596 18.08 15.2305 17.7 15.2305 17.24C15.2206 16.78 15.5862 16.401 16.0406 16.391H16.0505C16.5148 16.391 16.8902 16.771 16.8902 17.24C16.8902 17.71 16.5148 18.09 16.0505 18.09ZM11.1701 17.24C11.1899 17.7 11.5653 18.061 12.0198 18.04C12.4643 18.021 12.82 17.641 12.8002 17.181C12.7903 16.731 12.4248 16.38 11.9802 16.38C11.5258 16.401 11.1701 16.78 11.1701 17.24ZM7.09989 17.24C7.11965 17.7 7.49506 18.061 7.94951 18.04C8.39407 18.021 8.74973 17.641 8.72997 17.181C8.72009 16.731 8.35456 16.38 7.90999 16.38C7.45554 16.401 7.09989 16.78 7.09989 17.24ZM15.2404 13.601C15.2404 13.141 15.596 12.771 16.0505 12.761C16.4951 12.761 16.8507 13.12 16.8705 13.561C16.8804 14.021 16.5247 14.401 16.0801 14.41C15.6257 14.42 15.2503 14.07 15.2404 13.611V13.601Z" fill="currentColor" />
                                        <path opacity="0.4" d="M3.00336 9.2569C3.0162 8.6699 3.0656 7.5049 3.15846 7.1299C3.63267 5.0209 5.24298 3.6809 7.54485 3.4899H16.4559C18.738 3.6909 20.3681 5.0399 20.8423 7.1299C20.9342 7.4949 20.9836 8.6689 20.9964 9.2569H3.00336Z" fill="currentColor" />
                            ...
                            <SidebarMenu isTag="false" minititle='DV' pathname='/appointment/doctor-visit' title='Doctor Visit'>
                                <i className="icon">
                                    <svg className="icon-20" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-file-manager" bsPrefix={`nav-item ${active === 'file-manager' ? 'active' : ''} `} onClick={() => setActive('file-manager')} >
                    <CustomToggle eventKey="sidebar-file-manager" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>File Manager</Tooltip>}>
                            <i className="icon">
                                <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Accordion.Collapse eventKey="sidebar-file-manager" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" minititle='D' pathname='/file-manager/dashboard' title='Dashboard'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M16.0756 2H19.4616C20.8639 2 22.0001 3.14585 22.0001 4.55996V7.97452C22.0001 9.38864 20.8639 10.5345 19.4616 10.5345H16.0756C14.6734 10.5345 13.5371 9.38864 13.5371 7.97452V4.55996C13.5371 3.14585 14.6734 2 16.0756 2Z" fill="currentColor"></path>
                                        <path fillRule="evenodd" clipRule="evenodd" d="M4.53852 2H7.92449C9.32676 2 10.463 3.14585 10.463 4.55996V7.97452C10.463 9.38864 9.32676 10.5345 7.92449 10.5345H4.53852C3.13626 10.5345 2 9.38864 2 7.97452V4.55996C2 3.14585 3.13626 2 4.53852 2ZM4.53852 13.4655H7.92449C9.32676 13.4655 10.463 14.6114 10.463 16.0255V19.44C10.463 20.8532 9.32676 22 7.92449 22H4.53852C3.13626 22 2 20.8532 2 19.44V16.0255C2 14.6114 3.13626 13.4655 4.53852 13.4655ZM19.4615 13.4655H16.0755C14.6732 13.4655 13.537 14.6114 13.537 16.0255V19.44C13.537 20.8532 14.6732 22 16.0755 22H19.4615C20.8637 22 22 20.8532 22 19.44V16.0255C22 14.6114 20.8637 13.4655 19.4615 13.4655Z" fill="currentColor"></path>
                            ...
                            <SidebarMenu isTag="false" minititle='I' pathname='/file-manager/image-folder' title='Image'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SidebarMenu isTag="false" minititle='V' pathname='/file-manager/video-folder' title='Video'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <SidebarMenu isTag="false" minititle='D' pathname='/file-manager/document-folder' title='Document'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M18.8088 9.021C18.3573 9.021 17.7592 9.011 17.0146 9.011C15.1987 9.011 13.7055 7.508 13.7055 5.675V2.459C13.7055 2.206 13.5036 2 13.253 2H7.96363C5.49517 2 3.5 4.026 3.5 6.509V17.284C3.5 19.889 5.59022 22 8.16958 22H16.0463C18.5058 22 20.5 19.987 20.5 17.502V9.471C20.5 9.217 20.299 9.012 20.0475 9.013C19.6247 9.016 19.1177 9.021 18.8088 9.021Z" fill="#currentColor" />
                                        <path opacity="0.4" d="M16.084 2.56729C15.785 2.25629 15.263 2.47029 15.263 2.90129V5.53829C15.263 6.64429 16.174 7.55429 17.28 7.55429C17.977 7.56229 18.945 7.56429 19.767 7.56229C20.188 7.56129 20.402 7.05829 20.11 6.75429C19.055 5.65729 17.166 3.69129 16.084 2.56729Z" fill="#currentColor" />
                            ...
                            <Nav.Item as="li">
                                <Link className={`${location.pathname === '/file-manager/all-file' ? 'active' : ''} nav-link`} href="/file-manager/all-file">
                                    <i className="icon">
                                        <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>All Files</Tooltip>}>
                            ...
                            <SidebarMenu isTag="false" minititle='T' pathname='/file-manager/trash' title='Trash'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <SidebarMenu isTag="true" pathname='/chat/chat' title='Chat' target="_blank">
                    <i className="icon">
                        <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-mail" bsPrefix={`nav-item ${active === 'mail' ? 'active' : ''} `} onClick={() => setActive('mail')} >
                    <CustomToggle eventKey="sidebar-mail" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-mail" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" minititle="M" pathname='/mail/email' title='Mail'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M21.9999 15.9402C21.9999 18.7302 19.7599 20.9902 16.9699 21.0002H16.9599H7.04991C4.26991 21.0002 1.99991 18.7502 1.99991 15.9602V15.9502C1.99991 15.9502 2.00591 11.5242 2.01391 9.29821C2.01491 8.88021 2.49491 8.64621 2.82191 8.90621C5.19791 10.7912 9.44691 14.2282 9.49991 14.2732C10.2099 14.8422 11.1099 15.1632 12.0299 15.1632C12.9499 15.1632 13.8499 14.8422 14.5599 14.2622C14.6129 14.2272 18.7669 10.8932 21.1789 8.97721C21.5069 8.71621 21.9889 8.95021 21.9899 9.36721C21.9999 11.5762 21.9999 15.9402 21.9999 15.9402Z" fill="currentColor" />
                                        <path d="M21.476 5.6736C20.61 4.0416 18.906 2.9996 17.03 2.9996H7.05001C5.17401 2.9996 3.47001 4.0416 2.60401 5.6736C2.41001 6.0386 2.50201 6.4936 2.82501 6.7516L10.25 12.6906C10.77 13.1106 11.4 13.3196 12.03 13.3196C12.034 13.3196 12.037 13.3196 12.04 13.3196C12.043 13.3196 12.047 13.3196 12.05 13.3196C12.68 13.3196 13.31 13.1106 13.83 12.6906L21.255 6.7516C21.578 6.4936 21.67 6.0386 21.476 5.6736Z" fill="currentColor" />
                            ...
                            <SidebarMenu isTag="false" minititle="EC" pathname='/mail/email-compose' title='Email Compose'>
                                <i className="icon">
                                    <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-special" bsPrefix={`nav-item ${location.pathname === '/special-pages/billing' ? 'active' : '' || location.pathname === '/special-pages/calender' ? 'active' : '' || location.pathname === '/special-pages/kanban' ? 'active' : '' || location.pathname === '/special-pages/pricing' ? 'active' : ''} `} onClick={() => setActive('special')} >
                    <CustomToggle eventKey="sidebar-special" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-special" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/special-pages/billing' title='Billing' minititle='B'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/special-pages/calender' title='Calender' minititle='C'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/special-pages/kanban' title='Kanban' minititle='K'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/special-pages/pricing' title='Pricing' minititle='P'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/special-pages/timeline' title='Timeline' minititle='T'></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-auth" bsPrefix={`nav-item ${active === 'auth' ? 'active' : ''} `} onClick={() => setActive('auth')} >
                    <CustomToggle eventKey="sidebar-auth" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-auth">
                        <Accordion as="ul" className="navbar-nav iq-main-menu sub-nav">
                            <Accordion.Item eventKey="auth" as="li" bsPrefix={`nav-item ${location.pathname === '/auth/Simple/sign-in' ? 'active' : '' || location.pathname === '/auth/sign-up' ? 'active' : '' || location.pathname === '/auth/confirm-mail' ? 'active' : '' || location.pathname === '/auth/lock-screen' ? 'active' : '' || location.pathname === '/auth/recoverpw' ? 'active' : ''}`}>
                                <CustomToggle eventKey="auth" onClick={(activeKey: any) => setActiveMenu(activeKey)} className="nav-link">
                                    <i className="icon">
                                ...
                                <Accordion.Collapse eventKey="auth">
                                    <ul className="sub-nav">
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Default/login' title='Login' minititle='L'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Default/register' title='Register' minititle='R'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Default/confirm-mail' title='Confirm Mail' minititle='CM'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Default/lock-screen' title='Lock Screen' minititle='LS'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Default/recover-password' title='Recover password' minititle='RP'></SidebarMenu>
                                    </ul>
                                </Accordion.Collapse>
                            </Accordion.Item>
                            <Accordion.Item eventKey="animate" as="li" bsPrefix={`nav-item ${location.pathname === '/auth/Simple/sign-in' ? 'active' : '' || location.pathname === '/auth/sign-up' ? 'active' : '' || location.pathname === '/auth/email' ? 'active' : '' || location.pathname === '/auth/lock-screen' ? 'active' : '' || location.pathname === '/auth/reset-password' ? 'active' : '' || location.pathname === '/auth/account-deactivate' ? 'active' : ''}`}>
                                <CustomToggle eventKey="animate" onClick={(activeKey: any) => setActiveMenu(activeKey)} className="nav-link">
                                    <i className="icon">
                                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="currentColor"></path>
                                            <path d="M11.3194 14.3209C11.1261 14.3219 10.9328 14.2523 10.7838 14.1091L8.86695 12.2656C8.57097 11.9793 8.56795 11.5145 8.86091 11.2262C9.15387 10.9369 9.63207 10.934 9.92906 11.2193L11.3083 12.5451L14.6758 9.22479C14.9698 8.93552 15.448 8.93258 15.744 9.21793C16.041 9.50426 16.044 9.97004 15.751 10.2574L11.8519 14.1022C11.7049 14.2474 11.5127 14.3199 11.3194 14.3209Z" fill="currentColor"></path>
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>Animated</Tooltip>}>
                                        <i className="sidenav-mini-icon">AN</i>
                                    </OverlayTrigger>
                                    <span className="item-name">Animated</span>
                                    <i className="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" className="icon-18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                        </svg>
                                ...
                                <Accordion.Collapse eventKey="animate">
                                    <ul className="sub-nav">
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Animated/sign-in' title='Sign In' minititle='SI'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Animated/sign-up' title='Sign Up' minititle='SU'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Animated/email' title='Email' minititle='E'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Animated/lock-screen' title='Lock Screen' minititle='LS'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Animated/reset-password' title='Reset Password' minititle='RP'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Animated/two-factor' title='Two Factor' minititle='TF'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Animated/account-deactivate' title='Account Deactivate' minititle='AD'></SidebarMenu>
                                    </ul>
                                </Accordion.Collapse>
                            </Accordion.Item>
                            <Accordion.Item as="li" eventKey="popup" bsPrefix="nav-item">
                                <CustomToggle eventKey="popup" onClick={(activeKey: any) => setActiveMenu(activeKey)} className="nav-link">
                                    <i className="icon">
                                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="currentColor"></path>
                                            <path d="M11.3194 14.3209C11.1261 14.3219 10.9328 14.2523 10.7838 14.1091L8.86695 12.2656C8.57097 11.9793 8.56795 11.5145 8.86091 11.2262C9.15387 10.9369 9.63207 10.934 9.92906 11.2193L11.3083 12.5451L14.6758 9.22479C14.9698 8.93552 15.448 8.93258 15.744 9.21793C16.041 9.50426 16.044 9.97004 15.751 10.2574L11.8519 14.1022C11.7049 14.2474 11.5127 14.3199 11.3194 14.3209Z" fill="currentColor"></path>
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>Popup</Tooltip>}>
                                        <i className="sidenav-mini-icon">PP</i>
                                    </OverlayTrigger>
                                    <span className="item-name">Popup</span>
                                    <i className="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" className="icon-18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                        </svg>
                                ...
                                <Accordion.Collapse eventKey="popup"  >
                                    <ul className="sub-nav">
                                        <SidebarMenu isTag="false" staticIcon="true" title='Sign In' minititle='SI' modalopen={handleShow} pathname="#"></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" title='Sign Up' minititle='SU' modalopen={handleShow1} pathname="#"></SidebarMenu>
                                    </ul>
                                </Accordion.Collapse>
                            </Accordion.Item>
                            <Accordion.Item as="li" eventKey="simple" bsPrefix={`nav-item ${location.pathname === '/auth/Animated/sign-in' ? 'active' : '' || location.pathname === '/auth/simple/sign-up' ? 'active' : ''}`}>
                                <CustomToggle eventKey="simple" onClick={(activeKey: any) => setActiveMenu(activeKey)} className="nav-link">
                                    <i className="icon">
                                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="currentColor"></path>
                                            <path d="M11.3194 14.3209C11.1261 14.3219 10.9328 14.2523 10.7838 14.1091L8.86695 12.2656C8.57097 11.9793 8.56795 11.5145 8.86091 11.2262C9.15387 10.9369 9.63207 10.934 9.92906 11.2193L11.3083 12.5451L14.6758 9.22479C14.9698 8.93552 15.448 8.93258 15.744 9.21793C16.041 9.50426 16.044 9.97004 15.751 10.2574L11.8519 14.1022C11.7049 14.2474 11.5127 14.3199 11.3194 14.3209Z" fill="currentColor"></path>
                                    ...
                                    <OverlayTrigger placement="right" overlay={<Tooltip>Simple</Tooltip>}>
                                        <i className="sidenav-mini-icon">SM</i>
                                    </OverlayTrigger>
                                    <span className="item-name">Simple</span>
                                    <i className="right-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" className="icon-18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
                                        </svg>
                                ...
                                <Accordion.Collapse eventKey="simple" >
                                    <ul className="sub-nav">
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Simple/sign-in' title='Sign In' minititle='SI'></SidebarMenu>
                                        <SidebarMenu isTag="false" staticIcon="true" pathname='/auth/Simple/sign-up' title='Sign Up' minititle='SU'></SidebarMenu>
                                    </ul>
                                </Accordion.Collapse>
                            </Accordion.Item>
                        </Accordion>
                ...
                <Accordion.Item as="li" eventKey="sidebar-user" bsPrefix={`nav-item ${location.pathname === '/Users/user-profile' ? 'active' : '' || location.pathname === '/Users/user-add' ? 'active' : '' || location.pathname === '/Users/user-list' ? 'active' : ''} `} onClick={() => setActive('user')} >
                    <CustomToggle eventKey="sidebar-user" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-user">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/Users/user-profile' title='User Profile' minititle='UP'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/Users/user-add' title='Add User' minititle='AU'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/Users/user-list' title='User List' minititle='UL'></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="utilities-error" bsPrefix={`nav-item ${active === 'error' ? 'active' : ''} `} onClick={() => setActive('error')} >
                    <CustomToggle eventKey="utilities-error" active={activeMenu === 'utilities-error' ? true : false} onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="utilities-error">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/utilities/error404' title='Error 404' minititle='E'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/utilities/error505' title='Error 500' minititle='E'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/utilities/maintenance' title='Maintenance' minititle='M'></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="plugins" bsPrefix={`nav-item ${location.pathname === '/plugins/apexcharts' || location.pathname === '/plugins/button-hover' || location.pathname === '/plugins/treeview' || location.pathname === '/plugins/choicejs' || location.pathname === '/plugins/flatpicker' || location.pathname === '/plugins/fslightbox' || location.pathname === '/plugins/gallery-hover' || location.pathname === '/plugins/image-cropper' || location.pathname === '/plugins/loader' || location.pathname === '/plugins/select' || location.pathname === '/plugins/sweet-alert' || location.pathname === '/plugins/quill-editor' || location.pathname === '/plugins/uppy' ? 'active' : ''} `} onClick={() => setActive('pulgins')} >
                    <CustomToggle eventKey="plugins" active={activeMenu === 'plugins' ? true : false} onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>Plugins</Tooltip>}>
                            <i className="icon">
                                <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M12.0865 22C11.9627 22 11.8388 21.9716 11.7271 21.9137L8.12599 20.0496C7.10415 19.5201 6.30481 18.9259 5.68063 18.2336C4.31449 16.7195 3.5544 14.776 3.54232 12.7599L3.50004 6.12426C3.495 5.35842 3.98931 4.67103 4.72826 4.41215L11.3405 2.10679C11.7331 1.96656 12.1711 1.9646 12.5707 2.09992L19.2081 4.32684C19.9511 4.57493 20.4535 5.25742 20.4575 6.02228L20.4998 12.6628C20.5129 14.676 19.779 16.6274 18.434 18.1581C17.8168 18.8602 17.0245 19.4632 16.0128 20.0025L12.4439 21.9088C12.3331 21.9686 12.2103 21.999 12.0865 22Z" fill="currentColor"></path>
                                    <path d="M11.3194 14.3209C11.1261 14.3219 10.9328 14.2523 10.7838 14.1091L8.86695 12.2656C8.57097 11.9793 8.56795 11.5145 8.86091 11.2262C9.15387 10.9369 9.63207 10.934 9.92906 11.2193L11.3083 12.5451L14.6758 9.22479C14.9698 8.93552 15.448 8.93258 15.744 9.21793C16.041 9.50426 16.044 9.97004 15.751 10.2574L11.8519 14.1022C11.7049 14.2474 11.5127 14.3199 11.3194 14.3209Z" fill="currentColor"></path>
                    ...
                    <Accordion.Collapse eventKey="plugins">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/apexcharts' title='Apexcharts' minititle='A'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/button-hover' title='Button Hover' minititle='BH'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/treeview' title='Treeview' minititle='T'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/choicejs' title='Choice JS' minititle='CJ'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/flatpicker' title='Flatpicker' minititle='F'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/fslightbox' title='FSlightbox' minititle='F'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/gallery-hover' title='Gallery Hover' minititle='GH'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/image-cropper' title='Image Cropper' minititle='IC'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/loader' title='Loader' minititle='L'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/select' title='Select2' minititle='S'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/sweet-alert' title='Sweet Alert' minititle='SA'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/quill-editor' title='Quill' minititle='Q'></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/plugins/uppy' title='Uppy' minititle='U'></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>

                <SidebarMenu isTag="true" pathname='/blank/blank' title='Blank Page'>
                    <i className="icon">
                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path opacity="0.4" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83V17.16C3 20.26 4.77 22 7.81 22H16.191C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2" fill="currentColor"></path>
                            <path fillRule="evenodd" clipRule="evenodd" d="M8.07999 6.64999V6.65999C7.64899 6.65999 7.29999 7.00999 7.29999 7.43999C7.29999 7.86999 7.64899 8.21999 8.07999 8.21999H11.069C11.5 8.21999 11.85 7.86999 11.85 7.42899C11.85 6.99999 11.5 6.64999 11.069 6.64999H8.07999ZM15.92 12.74H8.07999C7.64899 12.74 7.29999 12.39 7.29999 11.96C7.29999 11.53 7.64899 11.179 8.07999 11.179H15.92C16.35 11.179 16.7 11.53 16.7 11.96C16.7 12.39 16.35 12.74 15.92 12.74ZM15.92 17.31H8.07999C7.77999 17.35 7.48999 17.2 7.32999 16.95C7.16999 16.69 7.16999 16.36 7.32999 16.11C7.48999 15.85 7.77999 15.71 8.07999 15.74H15.92C16.319 15.78 16.62 16.12 16.62 16.53C16.62 16.929 16.319 17.27 15.92 17.31Z" fill="currentColor"></path>
                ...
                <SidebarMenu isTag="true" pathname='/admin/admin' title='Admin'>
                    <i className="icon">
                        <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <SidebarMenu isTag="true" pathname='/' title='Components'>
                    <i className="icon">
                        <svg className="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <SidebarMenu isTag="true" pathname='/plugins/ui-color' title='Colors'>
                    <i className="icon">
                        <svg width="20" className="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Accordion.Item as="li" eventKey="sidebar-widget" bsPrefix={` ${location.pathname === '/widget/widgetbasic' || location.pathname === '/widget/widgetchart' || location.pathname === '/widget/widgetcard' ? 'active' : ''} nav-item`} onClick={() => setActive('widget')}>
                    <CustomToggle eventKey="sidebar-widget" active={activeMenu === 'sidebar-widget' ? true : false} onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-widget">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/widget/widgetbasic' title='Widget Basic' minititle="WB"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/widget/widgetchart' title='Widget Chart' minititle="WC"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/widget/widgetcard' title='Widget Card' minititle="WC"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-maps" bsPrefix={`nav-item ${active === 'maps' ? 'active' : ''} `} onClick={() => setActive('maps')} >
                    <CustomToggle eventKey="sidebar-maps" active={activeMenu === 'sidebar-maps' ? true : false} onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-maps">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/maps/google' title='Google' minititle="G"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-form" bsPrefix={`nav-item ${active === 'form' ? 'active' : ''} `} onClick={() => setActive('form')} >
                    <CustomToggle eventKey="sidebar-form" active={activeMenu === 'sidebar-form' ? true : false} onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-form" >
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/form/form-elements' title='Elements' minititle="E"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/form/form-wizard' title='Wizard' minititle="W"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/form/form-validation' title='Validation' minititle="V"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-table" bsPrefix={`nav-item ${active === 'table' ? 'active' : ''} `} onClick={() => setActive('table')} >
                    <CustomToggle eventKey="sidebar-table" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                        <OverlayTrigger placement="right" overlay={<Tooltip>Table</Tooltip>}>
                            <i className="icon">
                                <svg className="icon-20" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <Accordion.Collapse eventKey="sidebar-table">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/table/bootstrap-table' title='Bootstrap Table' minititle="BT"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/table/table-data' title='Data Table' minititle="DT"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/table/border-table' title='Bordered Table' minititle="BT"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/table/fancy-table' title='Fancy Table' minititle="FT"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/table/fixed-table' title='Fixed Table' minititle="FT"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
                <Accordion.Item as="li" eventKey="sidebar-icons" bsPrefix={`nav-item mb-5 ${active === 'icons' ? 'active' : ''} `} onClick={() => setActive('icons')} >
                    <CustomToggle eventKey="sidebar-icons" onClick={(activeKey: any) => setActiveMenu(activeKey)}>
                    ...
                    <Accordion.Collapse eventKey="sidebar-icons">
                        <ul className="sub-nav">
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/icons/solid' title='Solid' minititle="S"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/icons/outline' title='Outlined' minititle="O"></SidebarMenu>
                            <SidebarMenu isTag="false" staticIcon="true" pathname='/icons/dual-tone' title='Dual Tone' minititle="D"></SidebarMenu>
                        </ul>
                    </Accordion.Collapse>
                </Accordion.Item>
            </Accordion>
